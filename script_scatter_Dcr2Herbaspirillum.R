...
plot( heat$SumSpend, heat$control,  col="darkgray", xlim = c(-4,1), ylim = c(-4,1), cex = 0.7,pch=19, 
      xlab = "T. atroviride Dcr2-Spent media", ylab= "Without Fungus", main = "Herbaspirillum seropedicae SmR1")
