#analysis BarSeq for Herbaspirillum
...
plot( heat$SumSpend, heat$control,  col="darkgray", xlim = c(-4,1), ylim = c(-4,1), cex = 0.7,pch=19, 
      xlab = "T. atroviride WT-Spent media", ylab= "Without Fungus", main = "Herbaspirillum seropedicae SmR1")
...
legend(-1, -3, legend=c("Negative Fitness","Recovered","Iron", "ABC", "Arn-operon"),
